 ...
 */
class Slicvic_Tagger_Block_Adminhtml_CustomersGrid extends Mage_Adminhtml_Block_Customer_Grid
{
    /**
     * {@inheritdoc}
     */
     ...
     *
     * @param Slicvic_Tagger_Model_Resource_CustomersGridCollection $collection
